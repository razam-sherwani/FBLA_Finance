...
class _BudgetSavingsPageState extends State<BudgetSavingsPage> {
        ...
        actions: [
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor: const Color(0xFFADD8E6), // Light blue for action button
  ...
  Widget build(BuildContext context) {
    ...
    final Color primaryThemeBlue = const Color(0xFFADD8E6); // A softer light blue from the theme
    final Color strongGreen = Colors.green.shade700; // Darker green for readable "Remaining" text
    final Color warningOrange = Colors.orange.shade700; // Darkened for better readability
    final Color dangerRed = const Color(0xFFFFAB91); // Softer red for danger
    final Color lightBackgroundStart = const Color(0xFFF5F5F5); // Very light grey for background start
    final Color lightBackgroundEnd = Colors.blueGrey.shade50; // Slightly darker for gradient end
    final Color darkText = Colors.blueGrey[800]!;
    final Color mediumText = Colors.blueGrey[600]!;

    return Scaffold(
      backgroundColor: Colors.transparent, // Set scaffold background to transparent for gradient
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: lightBackgroundStart, // Match tab bar background to page background
      ...
      body: docID.isEmpty
          ...
          : Container( // Added Container for gradient background
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                  colors: [lightBackgroundStart, lightBackgroundEnd], // Subtle gradient
                ),
              ),
              child: Padding(
                ...
                child: showBudgets
                    ? Column(
                        children: [
                          _buildSummaryHeader("Your Budgets", "Track your spending to stay on top of your finances."), // Header for budgets
                          Expanded(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    Icon(Icons.category, color: primaryThemeBlue, size: 28), // Icon for budget
                    ...
                    : Column(
                        children: [
                          _buildSummaryHeader("Your Savings Goals", "Save up for your dreams and financial milestones."), // Header for savings goals
                          Expanded(
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      if (remainingOrExcess <= 0) {
                                        ...
                                        textColor = warningOrange; // Darkened yellow/orange
                                      }
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                  children: [
                                                    Icon(Icons.savings, color: primaryThemeBlue, size: 28), // Icon for savings goal
                                                    const SizedBox(width: 8),
                                                    Expanded(
                                                      child: Text(
                                                        goal['name'],
  ...
  // Helper widget to build a consistent summary header for both sections
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Divider(height: 30, thickness: 1, color: Colors.grey[300]), // Subtle divider
        ],
      ),
    );
  }
